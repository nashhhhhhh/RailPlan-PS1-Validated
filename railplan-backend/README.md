...
stays database-free. Migration head is **0009**. See
...
`alembic upgrade head` to install migrations through **0009**, then optionally
...
- Additive Alembic revisions 0002–0009 and integration tests
...
6. Run `alembic upgrade head` to install the ordered migration chain through 0009.
