...
import type {ReferenceData,GeoFeature,Availability,ApprovalHistory,SavedOptimiseInput,SavedOptimiseResult,ScenarioBPreviewInput,ScenarioCPreviewInput,OptimiseResult,OptimisationPage,OptimisationDetail,OptimisationArtifacts} from "./contracts.generated";
